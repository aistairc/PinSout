...
def CalculateCentroid2D(old_point_list):
    ...
    if area != 0.0:
        result = [centre_point[0] / area_total, centre_point[1] / area_total]
    else:
        print centre_point[0], centre_point[1]
        result = [ 0.0, 0.0 ]

    new_point_list = a.SortPointsClockwise2DClosed(result, point_list, True)
