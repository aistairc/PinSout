...
#                 # print used_index
                ...
                ceiling = []
                # print start_node
                start_node = self.merge_line(start_node)
        ...
        # print "result: ", wall_list2

        logger.info("Making the ROOM information from the Cluster data: "+str(len(result_wall)))
        a.visual_graph3(ceiling_list2)
        # print "result wall : ", result_wall
        # print "result ceiling : ", ceiling_list2
        # print "result floor : ", floor_list2
        return wall_list2
            ...
            for i in range(len(root_list)):
                if start_node[each_i] in root_list[i]:
                    if start_node[each_i+1] in root_list[i]:
                        # print(root_list[i], start_node[each_i], start_node[each_i+1])
