...
class MakeCityGMLData:
    ...
    def make_door_info (self, wall_normal_vector):
        ...
        for door_index in door_repoint_list_2:
            ...
            if len(door_index) == 2:
                ...
                # door_point_list.append(self.search_point_bounding(self.get_range(door_index[1]), wall_normal_vector))
    ...
    def make_point_surface (self):
        ...
        for door_info_index in door_surface_list:
            ...
            for temp_2_i in temp_list_2:
                # check_range.append(self.check_point_2Drange(temp_2_i, wall_surface_range))
    ...
    def clockwise_sort(self, wall_surface_list, ceiling_surface_list, floor_surface_list, door_surface_list, window_surface_list):
        ...
        for index in ceiling_surface_list:
            ...
            # test_list = list()
            # test_pcl = pcl.PointCloud(a)
            # test_list.append(test_pcl)
            # self.visual_viewer(test_list)
   ...
   # pred_cloud = pcl.load("/home/dprt/Desktop/dump2/Area_2_office_14_pred.ply")
   # ceiling_cloud = pcl.load("/home/dprt/Desktop/dump2/Area_2_office_14_ceiling.ply")
   # floor_cloud = pcl.load("/home/dprt/Desktop/dump2/Area_2_office_14_floor.ply")
   # wall_cloud = pcl.load("/home/dprt/Desktop/dump2/Area_2_office_14_wall.ply")
